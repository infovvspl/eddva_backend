...
export const INTEREST_QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { value: 'R', label: 'Physical Education or Workshop/Technical Skills' },
  ...
  // ── Self-estimated skills (Holland's own instruments — the SDS — score both
  // interest AND self-estimated competency separately; this section adds that
  // second signal instead of only asking what a student enjoys). ─────────────
  {
    id: 'q16',
    section: 'skills',
    question: 'Compared to my classmates, I am best at:',
    options: [
      { value: 'R', label: 'Fixing, assembling, or operating equipment' },
      { value: 'I', label: 'Solving mathematical or logical problems' },
      { value: 'A', label: 'Coming up with original, creative ideas' },
      { value: 'S', label: 'Understanding how others feel and helping them' },
      { value: 'E', label: 'Convincing people or negotiating' },
      { value: 'C', label: 'Keeping things organised and error-free' },
    ],
  },
  {
    id: 'q17',
    section: 'skills',
    question: "If my class had to pick someone for a task, I'd be picked for:",
    options: [
      { value: 'R', label: 'Setting up equipment or fixing something broken' },
      { value: 'I', label: 'Explaining a tricky concept clearly' },
      { value: 'A', label: 'Designing a poster, video, or performance' },
      { value: 'S', label: 'Resolving a conflict between classmates' },
      { value: 'E', label: 'Pitching an idea to the whole class' },
      { value: 'C', label: 'Managing the schedule and keeping records' },
    ],
  },
  {
    id: 'q18',
    section: 'skills',
    question: 'A skill people often compliment me on is:',
    options: [
      { value: 'R', label: 'My hands-on, practical skills' },
      { value: 'I', label: 'My analytical or research skills' },
      { value: 'A', label: 'My imagination and creativity' },
      { value: 'S', label: 'My empathy and people skills' },
      { value: 'E', label: 'My confidence and persuasion' },
      { value: 'C', label: 'My organisation and attention to detail' },
    ],
  },
  {
    id: 'q19',
    section: 'environment',
    question: 'I feel most comfortable in a place that is:',
    options: [
      { value: 'R', label: 'Full of tools, machines, or equipment' },
      { value: 'I', label: 'Quiet, with space to think and read' },
      { value: 'A', label: 'Visually inspiring and full of ideas' },
      { value: 'S', label: 'Warm, friendly, and full of people' },
      { value: 'E', label: 'Fast-paced and competitive' },
      { value: 'C', label: 'Neat, predictable, and well-organised' },
    ],
  },
  {
    id: 'q20',
    section: 'environment',
    question: "On a school trip, I'd most enjoy visiting a:",
    options: [
      { value: 'R', label: 'Factory or construction site' },
      { value: 'I', label: 'Science lab or observatory' },
      { value: 'A', label: 'Art gallery or film studio' },
      { value: 'S', label: 'Hospital, school, or NGO' },
      { value: 'E', label: 'Stock exchange or startup office' },
      { value: 'C', label: 'Bank or government office' },
    ],
  },
  {
    id: 'q21',
    section: 'values',
    question: "I'd feel most fulfilled by a career that lets me:",
    options: [
      { value: 'R', label: 'Physically build or repair things that last' },
      { value: 'I', label: 'Discover facts nobody knew before' },
      { value: 'A', label: 'Leave behind something creative and original' },
      { value: 'S', label: "Change someone's life for the better" },
      { value: 'E', label: 'Build something big and be recognised for it' },
      { value: 'C', label: 'Keep an important system running reliably' },
    ],
  },
  {
    id: 'q22',
    section: 'values',
    question: "If I had to choose, I'd rather be known as someone who is:",
    options: [
      { value: 'R', label: 'Skilled with their hands' },
      { value: 'I', label: 'Deeply knowledgeable' },
      { value: 'A', label: 'Wonderfully original' },
      { value: 'S', label: 'Kind and dependable' },
      { value: 'E', label: 'Bold and persuasive' },
      { value: 'C', label: 'Perfectly organised' },
    ],
  },
  {
    id: 'q23',
    section: 'aspirations',
    question: 'My dream job would let me spend most of my day:',
    options: [
      { value: 'R', label: 'Building, repairing, or operating something' },
      { value: 'I', label: 'Researching, experimenting, or analysing' },
      { value: 'A', label: 'Designing, writing, or performing' },
      { value: 'S', label: 'Teaching, counselling, or caring for people' },
      { value: 'E', label: 'Leading a team or closing deals' },
      { value: 'C', label: 'Planning, recording, and organising information' },
    ],
  },
  {
    id: 'q24',
    section: 'aspirations',
    question: "Ten years from now, the achievement I'd be proudest of is:",
    options: [
      { value: 'R', label: 'Having built or fixed something impressive with my own hands' },
      { value: 'I', label: 'Having made a real discovery or breakthrough' },
      { value: 'A', label: 'Having created something people admire' },
      { value: 'S', label: 'Having genuinely helped people in need' },
      { value: 'E', label: 'Having built a successful venture or led a big team' },
      { value: 'C', label: 'Having run something complex smoothly and reliably' },
    ],
  },
];
