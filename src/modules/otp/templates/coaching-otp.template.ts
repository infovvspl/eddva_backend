export function buildCoachingOtpEmailHtml(otp: string, name = "there"): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Your EDDVA Coaching Verification Code</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0"
          ...
          <!-- Header gradient -->
          <tr>
            <td style="background:linear-gradient(135deg,#EC4899,#F59E0B);
          ...
          <tr>
            <td style="padding:40px 48px 32px;">
              <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;
                ...
                Verify your coaching account email
              </h1>
              <p style="margin:0 0 28px;font-size:15px;color:#64748b;line-height:1.6;">
                Hi <strong style="color:#334155;">${name}</strong>, use the code below to
                complete your EDDVA Coaching account verification.
              </p>

              <!-- OTP Box -->
              <div style="background:linear-gradient(135deg,#fff7ed,#fdf2f8);
                ...
                <p style="margin:0 0 8px;font-size:12px;font-weight:700;
                          color:#ea580c;text-transform:uppercase;letter-spacing:0.15em;">
              ...
              <div style="background:#f8fafc;border-radius:12px;padding:20px 24px;margin-bottom:28px;">
                <p style="margin:0 0 10px;font-size:13px;font-weight:700;color:#475569;">
                  Keep your coaching account safe:
                </p>
          ...
          <tr>
            <td style="background:#f8fafc;padding:24px 48px;border-top:1px solid #e2e8f0;">
              <p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;line-height:1.6;">
                © ${new Date().getFullYear()} EDDVA · Aero Coaching Platform ·
